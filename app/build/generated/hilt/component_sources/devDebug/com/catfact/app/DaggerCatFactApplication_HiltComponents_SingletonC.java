...
import com.catfact.app.core.network.di.DebugInterceptorModule_ProvideCurlLoggingEntryFactory;
...
public final class DaggerCatFactApplication_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends CatFactApplication_HiltComponents.SingletonC {
    ...
    Provider<CurlLoggingInterceptor> curlLoggingInterceptorProvider;

    Provider<InterceptorEntry> provideCurlLoggingEntryProvider;
    ...
    Provider<TimberLogger> timberLoggerProvider;
    ...
    Set setOfInterceptorEntryBuilder() {
      SetBuilder setBuilder = SetBuilder.<InterceptorEntry>newSetBuilder(3);
      setBuilder.add(provideCurlLoggingEntryProvider.get());
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.curlLoggingInterceptorProvider = DoubleCheck.provider(new SwitchingProvider<CurlLoggingInterceptor>(singletonCImpl, 9));
      this.provideCurlLoggingEntryProvider = DoubleCheck.provider(new SwitchingProvider<InterceptorEntry>(singletonCImpl, 8));
      this.retryInterceptorProvider = DoubleCheck.provider(new SwitchingProvider<RetryInterceptor>(singletonCImpl, 11));
      this.provideRetryInterceptorEntryProvider = DoubleCheck.provider(new SwitchingProvider<InterceptorEntry>(singletonCImpl, 10));
      this.commonHeadersInterceptorProvider = DoubleCheck.provider(new SwitchingProvider<CommonHeadersInterceptor>(singletonCImpl, 13));
      this.provideCommonHeadersInterceptorEntryProvider = DoubleCheck.provider(new SwitchingProvider<InterceptorEntry>(singletonCImpl, 12));
      ...
      this.timberLoggerProvider = DoubleCheck.provider(new SwitchingProvider<TimberLogger>(singletonCImpl, 15));
      this.catFactRepositoryImplProvider = DoubleCheck.provider(new SwitchingProvider<CatFactRepositoryImpl>(singletonCImpl, 2));
      this.noOpEventTrackerProvider = DoubleCheck.provider(new SwitchingProvider<NoOpEventTracker>(singletonCImpl, 16));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new CatFactRepositoryImpl(singletonCImpl.provideCatFactDaoProvider.get(), singletonCImpl.provideCatFactApiProvider.get(), singletonCImpl.timberLoggerProvider.get());
          ...
          case 8: // java.util.Set<com.catfact.app.core.network.interceptor.InterceptorEntry> com.catfact.app.core.network.di.DebugInterceptorModule#provideCurlLoggingEntry
          return (T) DebugInterceptorModule_ProvideCurlLoggingEntryFactory.provideCurlLoggingEntry(singletonCImpl.curlLoggingInterceptorProvider.get());

          case 9: // com.catfact.app.core.network.interceptor.CurlLoggingInterceptor
          return (T) new CurlLoggingInterceptor();

          case 10: // java.util.Set<com.catfact.app.core.network.interceptor.InterceptorEntry> com.catfact.app.core.network.di.InterceptorModule#provideRetryInterceptorEntry
          ...
          case 11: // com.catfact.app.core.network.interceptor.RetryInterceptor
          return (T) new RetryInterceptor();

          case 12: // java.util.Set<com.catfact.app.core.network.interceptor.InterceptorEntry> com.catfact.app.core.network.di.InterceptorModule#provideCommonHeadersInterceptorEntry
          ...
          case 13: // com.catfact.app.core.network.interceptor.CommonHeadersInterceptor
          ...
          case 15: // com.catfact.app.core.logging.TimberLogger
          return (T) new TimberLogger();

          case 16: // com.catfact.app.core.telemetry.NoOpEventTracker
